	...
	*/
	public function fetchSectionTable($classId = null)
	{
		if($classId) {
			...
			<div class="well">
				Tên Ngành học : '.$classData['class_name'].'
			</div>

			<div id="messages"></div>

			<div class="pull pull-right">
	  			<button class="btn btn-default" data-toggle="modal" data-target="#addSectionModal" onclick="addSection('.$classId.')">Thêm lớp học</button>	
		  	</div>
			    		...
			    		foreach ($sectionData as $key => $value) {
			    			...
			    			$button = '<div class="btn-group">
							  ...
							  <ul class="dropdown-menu">
							    <li><a type="button" data-toggle="modal" data-target="#editSectionModal" onclick="editSection('.$value['section_id'].','.$value['class_id'].')"> <i class="glyphicon glyphicon-edit"></i> Chỉnh sửa</a></li>
							    <li><a type="button" data-toggle="modal" data-target="#removeSectionModal" onclick="removeSection('.$value['section_id'].','.$value['class_id'].')"> <i class="glyphicon glyphicon-trash"></i> Xóa</a></li>		    
							  </ul>
							</div>';

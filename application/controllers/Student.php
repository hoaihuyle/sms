			...
			foreach ($studentData as $key => $value) {
				...
				$button = '<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">			  	
				    <li><a href="#" data-toggle="modal" data-target="#editStudentModal" onclick="updateStudent('.$value['student_id'].')">Chỉnh sửa</a></li>
				    <li><a href="#" data-toggle="modal" data-target="#removeStudentModal" onclick="removeStudent('.$value['student_id'].')">Xóa</a></li>			    
				  </ul>
				</div>';

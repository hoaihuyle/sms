	...
	*/
	...
	{			
		...
		if($typeId == 1) {
			...
			$div = '<div class="well">
				<center>
					<h4>Tham dự : Student<h4>
					<h4> Ngành học: '.$classData['class_name'].' Lớp học : '.$sectionData['section_name'].'<h4>
					<h4> Năm : '.$year.' Month : '.$month.'<h4>		
					<small>	
						P : Có mặt <br />				
						A : Vắng <br />
						L : Trễ <br />
						UN : Không xác định <br />
					</small>
				</center>
			</div>

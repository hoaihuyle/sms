    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="subjectName" name="subjectName" placeholder="Tên môn học">
		  </div>
		  <div class="form-group">
		    <label for="totalMark">Tổng số điểm</label>
		    <input type="text" class="form-control" id="totalMark" name="totalMark" placeholder="Tổng điểm">
		  </div>
		  <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="editSubjectName" name="editSubjectName" placeholder="Tên môn học">
		  </div>
		  <div class="form-group">
		    <label for="editTotalMark">Tổng số điểm</label>
		    <input type="text" class="form-control" id="editTotalMark" name="editTotalMark" placeholder="Tổng điểm">
		  </div>
		  <div class="form-group">

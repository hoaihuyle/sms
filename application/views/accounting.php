...
<ol class="breadcrumb">
  ...
  if($this->input->get('opt') == 'crtpay') {
    echo '<li class="active">Tạo khoản thanh toán cho sinh viên</li>';
  } 
  else if ($this->input->get('opt') == 'mgpay') {
    echo '<li class="active">Quản lý khoản thanh toán</li>';
  }  
  else if ($this->input->get('opt') == 'mgexp') {
    echo '<li class="active">Quản lý chi tiêu</li>';
  }  
  else if ($this->input->get('opt') == 'ime') {
    echo '<li class="active">Quản lý thu nhập</li>';
  }  
  ?>  
</ol>
...
<div class="col-md-12">
  <div class="panel panel-default">
  	<div class="panel-heading">
  		<?php   
  	    if($this->input->get('opt') == 'crtpay') {
  		    echo 'Tạo khoản thanh toán cho sinh viên';
  		  } 		  
  		  else if ($this->input->get('opt') == 'mgexp') {
  		    echo 'Quản lý chi tiêu';
  		  }  
  		  else if ($this->input->get('opt') == 'ime') {
  		    echo 'Quản lý thu nhập';
  		  }  
  	    ?>  
  	</div>
  	<!-- /.panel-heading -->
      ...
      <div class="pull pull-right">
        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#add-expenses-modal" onclick="addExpenses()">Thêm khoản chi</button>        
      </div>
...
Quản lý thanh toán
		...
		<div class="list-group">
		  	<a type="button" class="list-group-item" id="managePaymentInfo">Quản lý khoản thanh toán</a>
